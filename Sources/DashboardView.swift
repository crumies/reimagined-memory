                ...
                VStack(spacing: compact ? 7 : 10) {
                    ...
                    if settings.hudShowTemps {
                        HStack {
                            ...
                            Spacer()
                            statusIcon("bolt.circle.fill", String(format: "%.0f°C", ble.telemetry.motorTemp))
                            Spacer()
...
struct RPMArc: View {
    ...
    var body: some View {
        ZStack {
            ...
            if progress > 0.68 {
                Circle()
                    .trim(from: 0.12 + 0.68 * 0.76, to: 0.12 + progress * 0.76)
                    .stroke(
                        AngularGradient(
                    ...
                    .rotationEffect(.degrees(90))
                    .shadow(color: .red.opacity(0.55), radius: 12)
            }
        }
    }
}
